...
function _createDoctor() {
  _createDoctor = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var _req$body, nomdoctor, apelldoctor, dnidoctor, teldoctor, emaildoctor, dirdoctor, espdoctor, clinicaid, newDoctor;
...
function getDoctor(_x3, _x4) {
  return _getDoctor.apply(this, arguments);
} //Seleccionar un doctor por id (GET)


function _getDoctor() {
  _getDoctor = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
    var doctor;
